<?php
    ...
    class PDF extends PDF_MySQL_Table
    {
        ...
        $pdf->Cell(100	,5,$savings['full_name'],0,0);
        ...
        $pdf->Cell(2.3	,2,'',0,0);
        $pdf->Cell(34	,5,'  SAVINGS',0,1);//end of line
        ...
        $pdf->AddCol('balance',40,'Balance','C');

        $pdf->Table($con,"SELECT date, description,debit,credit,balance FROM savings_transcations WHERE acc_no = '$s_accno'AND date >= '$date1 00:00:00' AND date <='$date2 23:59:59'");
