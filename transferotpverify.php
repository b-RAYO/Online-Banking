<?php
    ...
    if(isset($_POST['verifyotp'])) {
        $transfer_otp =$_POST['transfer_otp'];
        if($_COOKIE['transfer_otp'] == $transfer_otp) {
          ...
          if($s_amount && $s_total <=200 )
           ...
           elseif($r_accno == $s_accno){
            ...
            $_SESSION['wrongtransfer_otp'] = "PLEASE ENTER THE CORRECT OTP";
            header('location:transferotp.php');
        }
    }
?>